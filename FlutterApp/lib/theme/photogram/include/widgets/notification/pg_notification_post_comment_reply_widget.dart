...
class PgNotificationPostCommentReplyWidget extends StatefulWidget {
  final int notificationId;

  const PgNotificationPostCommentReplyWidget({
    Key? key,
    required this.notificationId,
  }) : super(key: key);

  @override
  State<PgNotificationPostCommentReplyWidget> createState() => _PgNotificationPostCommentReplyWidgetState();
}

class _PgNotificationPostCommentReplyWidgetState extends State<PgNotificationPostCommentReplyWidget>
    ...
    textSpans.add(
      TextSpan(
        text: _notificationModel.linkedContent.collections[UserTable.tableName]!.length > 2
            ? sprintf(
                AppLocalizations.of(context)!.andNOthersRepliedToYourCommentOnPost,
                [
                  _notificationModel.linkedContent.collections[UserTable.tableName]!.length - _userModels.length,
                ],
              )
            : AppLocalizations.of(context)!.repliedToYourCommentOnPost,
